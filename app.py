...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
     altura_txt = self.txt_altura.get()
     altura = int(altura_txt)
     if altura < 160: Posición = "Base"
     if 160 <= altura <= 179: Posición = "Escolta"
     if 180 <= altura <= 199: Posición = "Alero"
     if altura >= 200: Posición = "Pívot"
     alert("Posición", f"La posición del jugador es {Posición}") 
